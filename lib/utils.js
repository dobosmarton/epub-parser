...
exports.traverseNestedObject = function (_rootObject, config) {
    ...
    var traverse = function (rootObject) {
        var makeArray = function () {
            if (Array.isArray(rootObject) || lodash_1.default.isArrayLikeObject(rootObject) || lodash_1.default.isArrayLike(rootObject)) {
                return rootObject;
            }
            return [rootObject];
        };
        ...
        result = lodash_1.default.map(result, function (object, index) {
            ...
            if (object[childrenKey]) {
                ...
                var children = lodash_1.default.isEmpty(transformedChildren) ? undefined : lodash_1.default.flattenDeep(transformedChildren);
                if (transformer) {
                    return transformer(object, children);
                }
                return __assign({}, object, (_a = {},
